...
const sourceDir = path.join(distDir, 'notifications', 'src');
...
// Se existe dist/notifications/src, copiar tudo para dist/
if (fs.existsSync(sourceDir)) {
  // Copiar todos os arquivos e diretórios de notifications/src para dist/
  ...
  console.error('Could not find notifications/src directory in dist');
  process.exit(1);
}
