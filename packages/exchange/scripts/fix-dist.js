...
const sourceDir = path.join(distDir, 'exchange', 'src');
...
// Se existe dist/exchange/src, copiar tudo para dist/
if (fs.existsSync(sourceDir)) {
  // Copiar todos os arquivos e diretórios de exchange/src para dist/
  ...
  console.error('Could not find exchange/src directory in dist');
  process.exit(1);
}
