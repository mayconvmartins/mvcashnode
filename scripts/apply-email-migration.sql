...
-- Aplicar apenas esta migration sem resetar o banco
-- Execute este script diretamente no MySQL se houver problemas com drift
...
-- CreateTable: email_notification_logs
...
-- CreateTable: email_notifications_config
